                ...
                <View style={{ flexDirection: 'row', gap: 12 }}>
                    ...
                    <View style={{ width: '70%', padding: 12 }}>
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            ShowToast('Added');
                        }} style={{ borderRadius: 6, backgroundColor: color.yellow, padding: 4, marginTop: 12 }}>
                            <Text style={{ color: '#000', textAlign: 'center', fontWeight: '700', paddingHorizontal: 6 }}>Add to Cart</Text>
                        </TouchableOpacity>
                    </View>
                </View>
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <View style={{ backgroundColor: color.base, padding: '4%', alignSelf: 'center', width: "100%", borderBottomLeftRadius: 18, borderBottomRightRadius: 18 }}>
                <Text style={{ color: "#fff", fontSize: 16, bottom: 3, textTransform: 'capitalize', fontWeight: "600", textAlign: 'center', }} >Welcome {userName} </Text>
            </View>
            <FlatList
                ...
                ListFooterComponent={() => {
                    return (
                        <>
                            {currentData && <TouchableOpacity style={{ width: '60%', alignSelf: 'center', padding: 10, borderRadius: 15, alignItems: 'center', marginTop: "8%" }}
